...
syms c1 c2 m1 m2 l0 l1 l2 i1 i2 tau1 tau2 g k1 k2 k3 rx ry th10 th20 real
...
u = [tau1; tau2];
p = [c1 c2 m1 m2 l0 l1 l2 i1 i2 tau1 tau2 g k1 k2 k3 rx ry th10 th20];
...
V = m1*g*h1 + m2*g*h2; %potential energy due to gravity
V1 = 1/2*k1*(th1 - th10)^2;
V2 = 1/2*k2*(th2 - th20)^2;
V3 = 1/2*k3*(norm(rC - [rx; ry]) - l0)^2;


L = T - (V + V1 + V2 + V3); % lagrangian
E = T + V + V1 + V2 + V3; % total energy
...
u = [tau1; tau2];
z = [q; dq];
param = [c1 c2 m1 m2 l0 l1 l2 i1 i2 tau1 tau2 g k1 k2 k3 rx ry th10 th20];
